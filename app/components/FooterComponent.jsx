...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background-start to-background-end dark:from-background-dark-start dark:to-background-dark-end">
        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              type="email"
              required
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:placeholder-gray-500 dark:text-gray-300 sm:text-sm"
            />
          </div>
          <div>
